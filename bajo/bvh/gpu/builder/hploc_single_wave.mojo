...
def init_hploc_single_wave_kernel[
    ...
    guide_tasks: Span[mut=True, UInt32, MutAnyOrigin],
    cluster_indices: Span[mut=True, UInt32, MutAnyOrigin],
    cluster_counts: Span[mut=True, UInt32, MutAnyOrigin],
...
def build_hploc_single_wave_kernel[
    ...
    guide_tasks: Span[mut=False, UInt32, ImmutAnyOrigin],
    cluster_indices: Span[mut=True, UInt32, MutAnyOrigin],
    cluster_counts: Span[mut=True, UInt32, MutAnyOrigin],
    nearest_scratch: Span[mut=True, UInt32, MutAnyOrigin],
    compact_scratch: Span[mut=True, UInt32, MutAnyOrigin],
    allocation_base: Span[mut=True, UInt32, MutAnyOrigin],
    node_bounds: Span[mut=True, Float32, MutAnyOrigin],
    node_meta: Span[mut=True, UInt32, MutAnyOrigin],
    node_counter: Span[mut=True, UInt32, MutAnyOrigin],
    root: Span[mut=True, UInt32, MutAnyOrigin],
