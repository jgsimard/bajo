...
def _intersect_tlas_instance_block[
    ...
    blas_wide_meta: UnsafePointer[mut=False, UInt32, _],
...
def _trace_tlas_ray[
    ...
    tlas_wide_meta: UnsafePointer[mut=False, UInt32, _],
    tlas_leaf_instances: UnsafePointer[mut=False, UInt32, _],
    inst_inv_transform: UnsafePointer[mut=False, Float32, _],
    inst_blas_indices: UnsafePointer[mut=False, UInt32, _],
    blas_descs: UnsafePointer[mut=False, UInt32, _],
    ...
    while True:
        ...
        comptime for node_lane in range(tlas_width):
            ...
            var meta = UInt32(tlas_wide_meta[lane_base])
...
def trace_triangle_tlas_camera_kernel[
    ...
    tlas_wide_meta: UnsafePointer[UInt32, ImmutAnyOrigin],
    ...
    blas_wide_meta: UnsafePointer[UInt32, ImmutAnyOrigin],
...
def trace_sphere_tlas_camera_kernel[
    ...
    tlas_wide_meta: UnsafePointer[UInt32, MutAnyOrigin],
    ...
    blas_wide_meta: UnsafePointer[UInt32, MutAnyOrigin],
